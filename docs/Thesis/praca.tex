...
Wraz z treœci¹ pracy dyplomowej do³¹czono równie¿ p³ytê CD z kompletnym kodem Ÿród³owym aplikacji. Dodatkowo kod mo¿na pobraæ z poni¿szego repozytorium GIT: \texttt{https://github.com/tworzenieweb/Master-Thesis.git}
