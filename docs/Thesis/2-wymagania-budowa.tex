...
Druga aplikacja bêdzie zawiera³a zakres funkcjonalny zwyk³ego u¿ytkownika, natomiast wszystkie dane bêdzie pobiera³a przy u¿yciu \textit{webserwisów} udostêpnionych przez wczeœniej omawian¹ aplikacje. Aplikacja ta bêdzie napisana w jêzyku PHP z wykorzystaniem frameworka \textit{symfony}.\\
...
\begin{figure}[htbp]
\center
\caption{Schemat budowy aplikacji ksiêgarni internetowej}
...
Stworzenie aplikacji realizuj¹cej konkretne za³o¿enia jest w zasadzie ma³o skuteczne bez przemyœlanego zbioru przypadków u¿ycia i scenariuszy. Zaimplementowana aplikacja nie jest, co prawda bardzo rozbudowana funkcjonalnie, ale jest w zupe³noœci wystarczaj¹ca do przeprowadzenia analizy i optymalizacji wydajnoœci. Rozdzia³ ten stanowi podstawê dalszych rozwa¿añ. Dziêki sprecyzowaniu ogólnych ram projektu, mo¿liwe jest póŸniejsze unikniêcie b³êdów logicznych i problemów z implementacj¹ niemo¿liw¹ do realizacji. Projekt bazy danych dla stworzonej aplikacji jest typowy dla baz relacyjnych. W kolejnych rozdzia³ach zostan¹ przedstawione operacje konieczne do dostosowania schematu do konwencji \textit{NoSQL}.
