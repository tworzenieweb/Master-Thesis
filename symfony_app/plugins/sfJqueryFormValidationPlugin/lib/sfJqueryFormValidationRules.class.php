...
//      }
  ...
  public function getPostValidators()
  {
    ...
    foreach($this->forms as $form)
    {
      ...
      {
        if($this->parsePostValidator($form, $pv))
...
//          );
//          
//          $formName = $formName ? $formName . '_' : $formName;
//          
//          $return[] = "$('#{$formName}{$column}').rules('add', " . json_encode($rules) . ");";
//        }
//        return $return;
      ...
      case 'sfValidatorSchemaCompare':
        if($options['operator'] == '==' || $options['operator'] == '===') {
          ...
          $rules['equalTo'] = "#{$formName}{$options['left_field']}";
          $rules['messages'] = array(
          ...
          return "$('#{$formName}{$options['right_field']}').rules('add', " . json_encode($rules) . ");";
        }
        break;
    }
  }
