...
class sfGuardSecurityUser extends sfBasicSecurityUser
{
  ...
  public function signIn($user, $remember = false, $con = null)
  {
    ...
    $this->setAttribute('user_id', $user['user_id'], 'sfGuardSecurityUser');
    $this->setAttribute('user_email', $user['user_email'], 'sfGuardSecurityUser');
    $this->setAttribute('user_name', $user['user_name'], 'sfGuardSecurityUser');
    $this->setAttribute('user_lastname', $user['user_lastname'], 'sfGuardSecurityUser');
    $this->setAttribute('user_authorization', $user['Authorization'], 'sfGuardSecurityUser');
  ...
  public function getGuardUser()
  {
    if (!$this->user && $id = $this->getAttribute('user_id', null, 'sfGuardSecurityUser'))
    {
      ...
      $this->user->first_name = $this->getAttribute('user_first_name', null, 'sfGuardSecurityUser');
      $this->user->last_name = $this->getAttribute('user_last_name', null, 'sfGuardSecurityUser');
      $this->user->email_address = $this->getAttribute('user_email', null, 'sfGuardSecurityUser');
      $this->user->username = $this->getAttribute('user_email', null, 'sfGuardSecurityUser');
      $this->user->id = $this->getAttribute('user_id', null, 'sfGuardSecurityUser');
